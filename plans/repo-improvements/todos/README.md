...
| [05-realtime-logs.md](done/05-realtime-logs.md) | P1 | hard | codex（继承默认） | gpt-6-astra / max | 已完成：跨页跟随、有界历史窗口与通知刷新控制。 |
...
| [09-docs-and-acceptance.md](done/09-docs-and-acceptance.md) | P2 | easy | codex（继承默认） | gpt-6-astra / high | 已完成：修订当前使用说明，整理最终验证证据。 |
...
5. [05-realtime-logs.md](done/05-realtime-logs.md) — 已完成；依赖 04-submission-validation.md。
...
9. [09-docs-and-acceptance.md](done/09-docs-and-acceptance.md) — 已完成；依赖 01-database-lock-order.md、02-worker-identity.md、03-command-lifecycle.md、04-submission-validation.md、05-realtime-logs.md、06-worker-query-indexes.md、07-dependency-audit.md、08-setup-regressions.md。
